...
const topbotsSchema = require("./models/topBots.js");
...
client.on("messageCreate", async (message) => {
  ...
  if (message.content === "welcome") return client.emit("guildMemberAdd", message.member);
  ...
  if (message.guildId != "1077432247772258396") return;
